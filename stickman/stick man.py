...
class Game:
    def __init__(self):
        ...
        self.bg = PhotoImage(file="background.gif")#导入背景 平铺
        w = self.bg.width()
        h = self.bg.height()
        for x in range(0,5):
            for y in range(0,5):
...
door =DoorSprite(g,PhotoImage(file='door1.gif'),45,30,40,45)
